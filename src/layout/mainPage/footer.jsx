...
<footer >
<div className="w-full  p-4 py-6 lg:py-8" style={{ backgroundColor: '#edd6bb' }}>
...
<span className="text-md text-black-800  block mt-4">4517 Washington Ave. <br />Manchester, Kentucky <br /> 39495
          </span>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  <h2 className="mb-6 text-sm font-bold text-gray-900 uppercase dark:text-white">Policy</h2>
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-4">
              ...
              <div>
              <h2 className="mb-6 text-sm font-bold text-gray-900 uppercase dark:text-white">Social</h2>
      ...
      <div className="sm:text-center">
        <span className="text-sm text-black-500 "> Copyright ©2022 Zing Inc. All right reserved.</span>
    </div>
